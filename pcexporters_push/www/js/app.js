...
var base_url = "http://dev.pcexporters.com/services/";
...
angular.module('starter', ['ionic', 'ngIOS9UIWebViewPatch', 'starter.controllers', 'starter.services', 'ngMaterial', 'ngMessages', 'ngCordova'])
        .run(function ($ionicPlatform, $cordovaSQLite, $rootScope, $ionicHistory, $state, $mdDialog, $mdBottomSheet, $localstorage, $location) {
            ...
            $ionicPlatform.ready(function () {
                ...
                var pushNotificationActivated = function (payload) {
...
//        canRunActionsOnWake: true,
                    "onNotification": pushNotificationActivated
                });

                var user = Ionic.User.current();

                //if the user doesn't have an id, get an anonymous one
                if (!user.id) {
                ...
                user.save().then(function (res) {
                    ...
                    console.log("There was an error savign the user");
                });
            });
        ...
        .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
            ...
            $stateProvider
                    ...
                    .state('app.home', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/home.html",
                    ...
                    .state('app.main', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/main.html",
                                controller: "mainConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.list', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/list.html",
                                controller: "listConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.details', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/details.html",
                                controller: "detailsConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.login', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/login.html",
                                controller: "LoginConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.signup', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/signup.html",
                    ...
                    .state('app.dashboard', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/dashboard.html",
                                controller: "DashboardConnectCtrl"
                            }
                        }
                    })
                    .state('app.buyingleads', {
                        url: "/buyingleads",
                        params: {
                            catID: 0
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/buying-leads.html",
                                controller: "buyingleadsConnectCtrl"
                            }
                        }
                    })
                    .state('app.sellingleads', {
                        url: "/sellingleads",
                        params: {
                            catID: 0
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/selling-leads.html",
                                controller: "sellingleadsConnectCtrl"
                            }
                        }
                    })

                    .state('app.newsuppliers', {
                        url: "/new-suppliers",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/new-suppliers.html",
                                controller: "newsuppliersConnectCtrl"
                            }
                        }
                    })
                    .state('app.newsuppliersdetails', {
                        url: "/newsuppliersdetails/:slug",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/detail-supplier.html",
                                controller: "detailssuppliersConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.supplier-contact', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/supplier-contact.html",
                                controller: "supplier-contactConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.newbuyers', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/new-buyers.html",
                                controller: "newbuyersConnectCtrl"
                            }
                        }
                    })

                    .state('app.newbuyersdetails', {
                        url: "/newbuyersdetails/:slug",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/detail-buyers.html",
                                controller: "detailsbuyersConnectCtrl"
                            }
                        }
                    })

                    .state('app.buyer-contact', {
                        url: "/buyer-contact",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/buyer-contact.html",
                                controller: "buyer-contactConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.messages', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/messages.html",
                                controller: "messagesConnectCtrl"
                            }
                        }
                    })
                    .state('app.messageslist', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/messages-list.html",
                                controller: "messageslist"
                            }
                        }
                    })
                    .state('app.messages-reply', {
                        url: "/messages-reply",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/messages-reply.html",
                                controller: "messagesreplyConnectCtrl"
                            }
                        }
                    })
                    ...
                    .state('app.alerts', {
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/alerts.html",
                                controller: "alertsConnectCtrl"
                            }
                        }
                    })

                    .state('app.postSellingLeads', {
                        url: "/postSellingLeads",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/postSellingLeads.html",
                                controller: "postSellingLeadsConnectCtrl"
                            }
                        }
                    })

                    .state('app.postBuyingLeads', {
                        url: "/postBuyingLeads",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/postBuyingLeads.html",
                                controller: "postBuyingLeadsConnectCtrl"
                            }
                        }
                    })

                    .state('app.postProduct', {
                        url: "/postProduct",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/postProduct.html",
                                controller: "postProductConnectCtrl"
                            }
                        }
                    })

                    .state('app.listcatMembers', {
                        url: "/listcatMembers",
                        params: {
                            catID: null,
                            selectedOpt: null,
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/listcatMembers.html",
                                controller: "listcatMembersConnectCtrl"
                            }
                        }
                    })
                    .state('app.cat-options', {
                        url: "/cat-options",
                        views: {
                            'menuContent': {
                                templateUrl: "templates/main/html/cat-option.html",
                                controller: "cat-options"
                            }
                        }
                    })
